...
#include <Protocol/Darwin/ApplePartitionInfo.h>
#include <Protocol/Darwin/ApfsEfiBootRecordInfo.h>
#include <Protocol/Darwin/NullTextOutput.h>
#include <Guid/Darwin/AppleApfsInfo.h>
